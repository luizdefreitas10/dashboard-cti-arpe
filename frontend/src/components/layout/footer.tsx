  ...
  return (
    <footer className="border-t border-[var(--color-border)] bg-[var(--color-bg-sidebar)] mt-auto w-full">
      <div className="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="pb-16">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-[var(--color-text)]">ARPE</span>
            </div>
            <p className="text-sm text-[var(--color-text-muted)] leading-relaxed">
              Agência de Regulação de Serviços Públicos Delegados de Pernambuco
            </p>
            <p className="text-xs text-[var(--color-text-subtle)]">Governo de Pernambuco</p>
          </div>

          {/* Contatos */}
          <div className="space-y-3">
            <p className="text-sm font-medium text-[var(--color-text)]">Contatos</p>
          ...
          {/* Endereço */}
          <div className="space-y-3">
            <p className="text-sm font-medium text-[var(--color-text)]">Endereço</p>
          ...
          <div className="md:col-span-2 lg:col-span-1 flex flex-col gap-4">
            <div className="flex items-center gap-3 p-3 rounded-md bg-[var(--color-primary)]/10 border border-[var(--color-primary)]/20">
              ...
              <span className="font-semibold text-[var(--color-text)]">Coordenadoria de Tecnologia da Informação</span>
            </div>
        ...
        <div className="pt-8 pb-2 border-t border-[var(--color-border)] flex flex-col sm:flex-row items-center justify-between gap-4 w-full">
          <p className="text-xs text-[var(--color-text-subtle)] min-w-0">
